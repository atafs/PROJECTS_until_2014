...
public class Partido {
	...
	//attributes
	private String designacao; //nomePartido
	private ArrayList<Militante> militantes = new ArrayList<Militante>(); //conjunto de militantes
	...
	public void retiraMilitante(int numero) {
		...
		if(militantes.size() < 10) {
			throw new IllegalStateException("ERRO: NAO pode remover os fundadores");
		}
	...
	public String toString() {
		return "[PARTIDO: " + designacao + "; Numero de Militante: " + count + "; Ultimo militante: " + ultimoNumeroMilitante + "]";
	}
