 ...
 */
package pt.progJava.americoLib.control108.frame;
...
import pt.progJava.americoLib.control108.service.ClienteService;
...
public class ClienteFrame extends javax.swing.JFrame {
    ...
    private void connect(ChatMessage message) {
        ...
        if (message.getText().equals("NO")) {
            ...
            JOptionPane.showMessageDialog(this, "CONNECTION FAILERD.\n TRY AGAIN WITH A DIFERENT NAME");
            return; //FORCE THE METHOD TO LEAVE
        }
        //PASS THE MESSAGE RECEIVED ON PARAMETERS
        this.message = message;
        //DISABLE BUTTONS
        this.btnConectar.setEnabled(false);
        this.txtName.setEditable(false);

        //ENABLE BUTTONS AND AREA
	...
	private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("USERS ONLINE"));
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        //VERIFY IF THERE IS A NAME SELECTED (RESERVED MESSAGE
        if (this.listOnlines.getSelectedIndex() > -1) {
            this.message.setNameReserved( (String) this.listOnlines.getSelectedValue() );
            this.message.setAction(Action.SEND_ONE);
            this.listOnlines.clearSelection(); //CLEAR SELECTION   

        } else {
            this.message.setAction(Action.SEND_ALL); //ELSE, SEND TO ALL
        }
