...
public class Start_SERVER_CLIENTE_03_client_multipleMessages extends JFrame{
	...
	public Start_SERVER_CLIENTE_03_client_multipleMessages(String nome) throws Exception {
		super("Chat: " + nome);
		this.nome = nome;
	...
	public static void main(String[] args) throws Exception {
		new Start_SERVER_CLIENTE_03_client_multipleMessages("Americo");
		new Start_SERVER_CLIENTE_03_client_multipleMessages("Tomas");
	}
}
