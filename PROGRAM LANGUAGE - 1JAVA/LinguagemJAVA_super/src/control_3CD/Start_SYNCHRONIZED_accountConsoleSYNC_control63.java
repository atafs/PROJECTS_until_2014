...
import pt.progJava.americoLib.control63.ContaConjuntaSYNC;

public class Start_SYNCHRONIZED_accountConsoleSYNC_control63 implements Runnable {//rodar em varias Threads

	//compras em familia em comum (?)
	ContaConjuntaSYNC conta = new ContaConjuntaSYNC();
	
	public static void main(String[] args) {
		
		//abrir varias Threads ao mesmo tempo
		Start_SYNCHRONIZED_accountConsoleSYNC_control63 irAsCompras = new Start_SYNCHRONIZED_accountConsoleSYNC_control63();
