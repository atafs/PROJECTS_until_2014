...
public class Start_PCD_control17_FormReclamacao extends JFrame {
	...
	public static void main(String[] args) {
		...
		Start_PCD_control17_FormReclamacao cp = new Start_PCD_control17_FormReclamacao();
		cp.setVisible(true);

	}

	public Start_PCD_control17_FormReclamacao() {
