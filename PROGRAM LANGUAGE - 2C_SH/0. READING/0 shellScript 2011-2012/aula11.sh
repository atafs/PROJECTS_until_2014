...
echo "13. O Nome e Numero das contas (3º elemento do NIB) são: "
cat aula11.log | awk '{print $6 $2}' | sort -n > aula11.3.log   
echo ""

echo "12. Corta o NIB por Todo (desaparece) "
cat aula11.log | sed 's/ [0-9\-]* / /' > aula11.5.log  
echo ""
...
echo "13. O Nome e Numero das contas (3º elemento do NIB) são: "
cat aula11.log | awk '{print $6 $2}' | sort -n | tail 1 > aula11.7.log   
echo ""
